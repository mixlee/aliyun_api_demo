...
# -*- coding:utf-8 -*-
# ########################################
# Function:    演示阿里云裸API使用方法 ECS服务
# Example Usage: python ecs_py2.py  Action=DescribeInstances RegionId=cn-qingdao
# ########################################
...
def make_request(user_params, quiet=False):
    ...
    url = ecs_server_address + "/?" + urllib.urlencode(params)
    print(url)
    req = requests.get(ecs_server_address, params)
    print(req.json())
