...
# -*- coding:utf-8 -*-
# ########################################
# Function:    演示阿里云裸API使用方法 CDN服务
# Example Usage:  python cdn.py Action=DescribeCdnDomainLogs DomainName=appcdn.example.com LogDay=2018-05-20 PageSize=1000
# ########################################
...
def make_request(user_params, quiet=False):
    ...
    url = cdn_server_address + "/?" + urllib.urlencode(params)
    print(url)
    req = requests.get(cdn_server_address, params)
    print(req.json())
